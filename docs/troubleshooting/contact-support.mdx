...
<Card title="support@clinic.com" icon="envelope">
...
<Card title="Data Protection Policy" icon="shield-check">
  Read our full privacy and data handling policy: [privacy@clinic.com](mailto:privacy@clinic.com)
</Card>
