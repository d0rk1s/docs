...
El sistema actualiza automáticamente el estado de las citas:
1. Cuando la hora de fin de una cita ya pasó
...
<Tip>
Si una cita se completó pero el estado no cambió, espera unos minutos. El sistema actualiza automáticamente.
</Tip>
