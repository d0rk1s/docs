---
title: "Widget de Próximas Citas"
description: "Visualiza y gestiona las citas del día en tiempo real"
icon: "calendar-days"
---

## ¿Qué es el widget de próximas citas?

Es una tabla interactiva en el Dashboard que muestra las **próximas citas del día** con detalles clave para operación rápida.
...
<Frame>
  <img src="/images/screenshots/dashboard_appointments_widget.png" alt="Widget de próximas citas mostrando tabla con hora, paciente, servicio, proveedor y acciones" />
</Frame>
...
**Objetivo**: Saber quién viene en las próximas horas.
...
**Objetivo**: Mover una cita de 10:00 a 10:30 porque el paciente avisa que llegará tarde.
...
**Problema**: No puedes ver citas de mañana o la próxima semana desde el Dashboard.

**Solución**: Usa la sección **"Citas"** (menú lateral) para ver el calendario completo.

---

### 2. No permite crear citas

**Problema**: El widget solo visualiza, no tiene botón "Crear nueva cita".
...
**Solución (temporal)**: Usa la columna "Proveedor" para identificar visualmente.
...
**Solución**: Usa reportes históricos (en desarrollo) o exporta datos vía API.
...
**Escenario**: Cita de las 10:00, paciente no apareció, ahora son las 10:45.
...
**Escenario**: Tenías un servicio "Manicura", creaste citas con ese servicio, luego eliminaste "Manicura" de la lista de servicios.
...
**Límite práctico**: Hasta 50 citas en el widget sin degradación de UX.
